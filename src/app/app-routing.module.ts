...
const routes: Routes = [
  ...
  {path: 'presentes', component: ProductsListComponent},
  {path: 'presentes/:id', component: ProductDetailComponent},
  {path: 'lista-presentes', component: CartComponent},
  ...
  {path: 'register-login', component: RegisterLoginComponent},
  {
    ...
    children: [
      ...
      {path: 'presentes-confirmados', component: OrdersComponent},
